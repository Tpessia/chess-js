...
import { jsonDateReviver, tryParseJson } from '@/utils/json/json-utils';
...
export function flattenObject(obj: any, separator: string = '.', skipArrays: boolean = false): Dictionary<any> {
    let flattenKeys: Dictionary<any> = {};
...
export function renameObjectKeys(obj: any, replacements: Dictionary<string>) {
